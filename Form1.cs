    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            if (meth.Text == "2.1")
            {
             ...
             0.002 * x3 * x4 + 48.273 * x11 * x15;
                m3 = 0.246 - 37.666 * x8 * x11 - 1.381 * x2 * x17 + 0.434 * x10 * x17 + (2.61e-06) * Math.Pow(x4, 2) + 
             0.473 * x8 * x10 - 0.0007 * x3 * x6 - 0.256 * x1 * x19 + 0.0007 * x1 * x12 - (1.53e-05) * x4 * x14;
        ...
        String check_models(Double m1, Double m2, Double m3)
        {
            String result_;
